...
row_count_df.to_csv(f"../stats/row_count.tsv", sep="\t", header=True, index=True)
sentence_count_df.to_csv(f"../stats/sentence_count.tsv", sep="\t", header=True, index=True)
word_count_df.to_csv(f"../stats/word_count.tsv", sep="\t", header=True, index=True)
unique_word_count_df.to_csv(f"../stats/unique_word_count.tsv", sep="\t", header=True, index=True)
